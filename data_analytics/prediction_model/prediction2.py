...
class PredictionModel:
    ...
    def drop_attributes(self):
        features = ['delay', 'time', 'dayofweek', 'month', 'temp', 'Sky is Clear', 'broken clouds', 'few clouds', 'fog',
                    'drizzle', 'light intensity drizzle', 'light intensity drizzle rain', 'light intensity shower rain',
                    'light rain', 'light shower sleet', 'mist', 'moderate rain', 'overcast clouds',
                    'proximity shower rain', 'scattered clouds', 'shower rain', '312', '317', '346', '400', '493',
                    '494', '495', '1444', '1445', '1449', '1450', '1451', '2191', '2192', '2193', '2194', '2195',
                    '2196', '2197', '2198', '2193', '2200', '2201', '2213', '2214', '2215', '2216', '2217', '2218',
                    '2219', '3365', '3366', '3367', '3886', '3887', '3888', '3918', '3954', '3955', '3956', '3957',
