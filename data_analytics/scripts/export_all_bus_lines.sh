...
awk -F',' '{ if ($3 == "66") print $0 }' $path_trips_df | sort -S 50% --parallel=4 -t',' -k1,1 -k2,2n -k4,4n >> $pathBusTrips
...
LC_ALL=C grep -f $pathTripID $pathLT | sort -t',' -k1,1 -k2,2n -k3,3 > $pathBusLT
